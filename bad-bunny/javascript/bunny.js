//Un-Verano-Sin-Ti functions
function revealAlbum6 () 
{
...
function hideAlbum6 ()
{
  document.getElementById ("Un-Verano-Sin-Ti-frame").style.display = 'none';
}

//EL-ULTIMO-TOUR-DEL-MUNDO functions
...
function hideAlbum5 ()
{
  document.getElementById ("EL-ULTIMO-TOUR-DEL-MUNDO-frame").style.display = 'none';
}

//LAS-QUE-NO-IBAN-A-SALIR functions
...
function hideAlbum4 ()
{
  document.getElementById ("LAS-QUE-NO-IBAN-A-SALIR-frame").style.display = 'none';
}
...
function hideAlbum3 ()
{
  document.getElementById ("YHLQMDLG-frame").style.display = 'none';
}
...
function hideAlbum2 ()
{
  document.getElementById ("OASIS-frame").style.display = 'none';
}
...
function hideAlbum ()
{
  document.getElementById ("X-100PRE-frame").style.display = 'none';
}